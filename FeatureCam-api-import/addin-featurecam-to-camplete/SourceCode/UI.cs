...
namespace FeatureCAMToCAMplete
{
    public partial class UI : Form
    {
        ...
        private void btnMetricsTest_Click(object sender, EventArgs e)
        {
            FCToCAMplete.RunMetricsTest();
        }
        ...
        private void btnRunFolder_Click(object sender, EventArgs e)
        {
            ...
            {
                fbd.Description = "Select folder containing STEP files";
            ...
            using (var fbd = new FolderBrowserDialog())
            {
                fbd.Description = "Select output folder for metrics";
                if (fbd.ShowDialog() != DialogResult.OK)
                    return;
            ...
            FCToCAMplete.RunBatch(inputDir, outputDir);
        }
    }
}
